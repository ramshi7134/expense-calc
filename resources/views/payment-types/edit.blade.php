...
@section('content')
    <div class="container">
        <h1 class="h3 mb-3">Edit Payment Type</h1>
                        ...
                        <form action="{{ route('payment-types.update', $paymentType) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    value="{{ $paymentType->name }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="type" class="form-label">Type</label>
                                <select name="type" id="type" class="form-select">
                                    <option value="debit" @selected($paymentType->type == 'debit')>Debit</option>
                                    <option value="credit" @selected($paymentType->type == 'credit')>Credit</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" name="statement_day" id="statement_day" class="form-control"
                                    min="1" max="31" value="{{ $paymentType->statement_day }}"
                                    placeholder="e.g., 2 for the 2nd of every month">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="last_four_digits" id="last_four_digits" class="form-control"
                                    maxlength="4" value="{{ $paymentType->last_four_digits }}" placeholder="e.g., 1234">
